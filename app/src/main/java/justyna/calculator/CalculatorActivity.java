...
public class CalculatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayTextView = (TextView) findViewById(R.id.textView);//używamy po setContentView, bo wczęsniej nie istaniej widok
    }

    @Override
    protected void onSaveInstanceState(Bundle outState){ //Bundle- mapa, w której przechowujemy inne obiekty, do których możemy się
                                                            // dostawać poprzez określony klucz- String
        super.onSaveInstanceState(outState);
        outState.putString(DISPLAY_KEY, display);//zapamiętuje display
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState){
        ...
        display=savedInstanceState.getString(DISPLAY_KEY, "0"); //odzyskiwanie display
